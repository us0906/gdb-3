...
/**
 * Performance test for the Betriebsstaette entity.
 */
class BetriebsstaetteGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Betriebsstaette entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all betriebsstaettes")
            .get("/api/betriebsstaettes")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new betriebsstaette")
            .post("/api/betriebsstaettes")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "bsnr":"SAMPLE_TEXT"
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created betriebsstaette")
                .get("${new_betriebsstaette_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created betriebsstaette")
            .delete("${new_betriebsstaette_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
