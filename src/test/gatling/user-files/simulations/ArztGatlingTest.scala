...
/**
 * Performance test for the Arzt entity.
 */
class ArztGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Arzt entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all arzts")
            .get("/api/arzts")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new arzt")
            .post("/api/arzts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created arzt")
                .get("${new_arzt_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created arzt")
            .delete("${new_arzt_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
