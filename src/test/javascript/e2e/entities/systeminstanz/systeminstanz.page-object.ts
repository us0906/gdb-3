...
export default class SysteminstanzComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('systeminstanz-heading'));
...
export class SysteminstanzDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('gdb3App.systeminstanz.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-systeminstanz'));
}
