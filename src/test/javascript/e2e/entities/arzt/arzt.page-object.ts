...
export default class ArztComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('arzt-heading'));
...
export class ArztDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('gdb3App.arzt.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-arzt'));
}
