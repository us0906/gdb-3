...
export default class ZubehoerComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('zubehoer-heading'));
...
export class ZubehoerDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('gdb3App.zubehoer.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-zubehoer'));
}
