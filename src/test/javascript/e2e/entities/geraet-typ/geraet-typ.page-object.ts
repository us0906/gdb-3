...
export default class GeraetTypComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('geraet-typ-heading'));
...
export class GeraetTypDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('gdb3App.geraetTyp.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-geraetTyp'));
}
