...
export default class SystemnutzungComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('systemnutzung-heading'));
...
export class SystemnutzungDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('gdb3App.systemnutzung.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-systemnutzung'));
}
