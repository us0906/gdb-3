...
export default class BetriebsstaetteComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('betriebsstaette-heading'));
...
export class BetriebsstaetteDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('gdb3App.betriebsstaette.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-betriebsstaette'));
}
