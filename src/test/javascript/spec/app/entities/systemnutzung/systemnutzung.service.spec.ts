...
describe('Service Tests', () => {
  describe('Systemnutzung Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Systemnutzung', async () => {
      ...
      it('should not update a Systemnutzung', async () => {
      ...
      it('should not return a list of Systemnutzung', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a Systemnutzung', async () => {
