...
describe('Service Tests', () => {
  describe('Systemtyp Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Systemtyp', async () => {
      ...
      it('should not update a Systemtyp', async () => {
      ...
      it('should not return a list of Systemtyp', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a Systemtyp', async () => {
