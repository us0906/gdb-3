...
if Maven fails while starting jhipster, delete target/elasticsearch-Folder and restart.
...
To build the final jar and optimize the gdb3 application for production, run:
